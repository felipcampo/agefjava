...
import jpa.entities.Departamento;
import jsf.util.JsfUtil;
import jpa.sessions.DepartamentoFacade;
...
public class DepartamentoController implements Serializable {
    ...
    private LazyDataModel<Departamento> lazyModel = null;
    @EJB
    private jpa.sessions.DepartamentoFacade ejbFacade;
    ...
    public void setSelected(Departamento entity) {
        current = entity;
    }
        ...
        if (lazyModel == null) {
            lazyModel = new LazyDataModel<Departamento>() {
                ...
                public List<Departamento> load(int first, int pageSize, String sortField, SortOrder sortOrder, Map<String, String> filters) {
                    ...
                    List<Departamento> result = getFacade().getResultList(first, pageSize, sortField, sortOrder, filters);
                    if (result.isEmpty()) {
                ...
                @Override
                public Object getRowKey(Departamento entity) {
    ...
    public String prepareView() {
        current = (Departamento) getLazyModel().getRowData();
        return "View";
    }
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/properties/Bundle").getString("DepartamentoCreated"));
            return "View";
        } catch (Exception e) {
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/properties/Bundle").getString("DepartamentoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/properties/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/properties/Bundle").getString("DepartamentoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/properties/Bundle").getString("PersistenceErrorOccured"));
        }
    }
